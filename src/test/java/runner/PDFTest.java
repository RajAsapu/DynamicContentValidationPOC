...
public class PDFTest {
    ...
    public void getLuceneDocument()throws Exception{
        ...
        for(File file:files){
            ...
            org.apache.lucene.document.Document document=lucenePDFDocument.convertDocument(new File("/Users/raj_asapu/DynamicContentValidationPOC/src/main/resources/pdfs/"+file.getName()));
